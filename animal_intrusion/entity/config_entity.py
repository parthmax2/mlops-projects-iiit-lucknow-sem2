...
class ModelTrainerConfig:
    ...
    no_epochs: int = MODEL_TRAINER_NO_EPOCHS
    batch_size: int = MODEL_TRAINER_BATCH_SIZE
    data_yaml_path: str = os.path.abspath(r"C:\Users\91874\Desktop\New folder (17)\mlops project\animal-intrusion-system-with-mlops-implementation\data\data.yaml")
  # ✅ new field
